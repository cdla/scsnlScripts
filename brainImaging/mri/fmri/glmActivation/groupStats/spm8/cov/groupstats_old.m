...
spmanalysis_path = '/oak/stanford/groups/menon/scsnlscripts/brainImaging/mri/fmri/glmActivation/groupStats/spm8/'; %'/oak/stanford/groups/menon/scsnlscripts_vsochat/fmri/spm/spm8/analysis/';
...
% -------------------------------------------------------------------------
subjects1 = csvread(subjlist_file{1},1);
batchfile   = 'batch_1group.mat';
numsubg1 = length(subjects1);

if(numgroup == 2)
  subjects2 = csvread(subjlist_file{2},1);
...
for subcnt1 = 1:numsubg1
    ...
    sub_stats1{subcnt1} = fullfile(project_dir, 'results', fmri_type, 'participants', ...
...
if numgroup == 2
   for subcnt2 = 1:numsubg2
      ...
      sub_stats2{subcnt2} = fullfile(project_dir, 'results', fmri_type, 'participants', ...
                                   subject, ['visit',visit],['session',session], analysis_type, ...
                                   ['stats_', spm_version], stats_folder);    
   end
end
