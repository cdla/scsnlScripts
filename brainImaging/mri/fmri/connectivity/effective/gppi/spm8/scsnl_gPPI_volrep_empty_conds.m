...
fprintf('Script: %s\n', which('scsnl_gPPI_volrep_empty_conds.m'));
...
%spmgppi_path =  fullfile('/Users/yuanzh/Desktop/Sherlock/scsnlscripts/brainImaging/mri/fmri/connectivity/effective/gppi/',spm_version);

spm_path = fullfile('/Users/yuanzh/Desktop/Sherlock/toolboxes/',spm_version);
...
Common_scripts_path = fullfile('/Users/yuanzh/Desktop/Sherlock/scsnlscripts/brainImaging/mri/fmri/preprocessing/spm8/utils/');
...
addpath(genpath('/Users/yuanzh/Desktop/Sherlock/projects/changh/2018_miscellaneous/toolboxes/PPPI_v2012_1_22'));
addpath(genpath(Common_scripts_path));
addpath('/Users/yuanzh/Desktop/Sherlock/projects/changh/2018_miscellaneous/toolboxes/gPPI_empty_conds');
...
%         session           = num2str(subjectlist(i_subj,3));
        ...
        subject_gPPI_stats_dir = fullfile(data_server, '/results/taskfmri/participants', subject, ['visit',visit],['session',session],'glm', ['stats_spm8'], [stats_folder, '_gPPItest']);
        subject_gPPI_stats_dir_temp = fullfile(data_server, '/results/taskfmri/participants', subject, ['visit',visit],['session',session],'glm', ['stats_spm8'], [stats_folder, '_gPPItest'], 'tempstats');
...
%}
        ...
        %%%HC changed to PPPI script modified to allow empty conditions
        %PPPI_wc(['gPPI_', subject, '_analysis_', roi_name{i_roi}, '.mat']);
        %PPPI_empty_conds_MS_copy(['gPPI_', subject, '_analysis_', roi_name{i_roi}, '.mat']);

        PPPI_empty_conds(['gPPI_', subject, '_analysis_', roi_name{i_roi}, '.mat']);
	    ...
	    %scsnl_art_redo_MS(subject_gPPI_stats_dir_temp, prep_pipeline, gPPI_roi_dir, img_path);
        %scsnl_art_redo_MS(fullfile(subject_gPPI_stats_dir_temp, ['PPI_', roi_name{i_roi}]), prep_pipeline, gPPI_roi_dir, img_path);
