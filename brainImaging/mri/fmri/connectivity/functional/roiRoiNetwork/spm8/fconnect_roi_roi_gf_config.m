...
paralist.roi_dir = '/oak/stanford/groups/menon/projects/yuanzh/2017_fconn_EI/scripts/taskfmri/fconn/ROI_Neurosynth'; %'/oak/stanford/groups/menon/projects/yuanzh/2017_Autism_Anxiety/scripts/restfmri/funconn/Seeds';

% Please specify the ROI list (full file name with extensions)
paralist.roi_list = '/oak/stanford/groups/menon/projects/yuanzh/2017_fconn_EI/scripts/taskfmri/fconn/ExtractROIBeta/ROI_files.txt'; %'/oak/stanford/groups/menon/projects/yuanzh/2017_Autism_Anxiety/scripts/restfmri/funconn/roi_list_test.txt';
